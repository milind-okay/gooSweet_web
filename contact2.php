			 				...
			 				<p>Fill this form and we will contact you.</p>
							  <form action="contact.php" method="POST">
								 <div class="form_details">
					                 <input type="text" class="text" name="contact_N" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}">
									 <input type="text" class="text" name="contact_E" value="Email Address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}">
									 <input type="text" class="text" name="contact_S" value="Subject" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Subject';}">
...
<div class="g-page" data-href="//plus.google.com/u/0/104589961241429205520" data-rel="publisher"></div>
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="footer">
		<div class="container">
	<div class="fb-like" data-href="https://www.facebook.com/goosweetam" data-width="800" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
