...
<div class="col-md-9">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="web/images/101.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="web/images/m101.jpg" class="img-responsive" title="" />
								</a>
							</li>
				 ...
				 <div class="desc1 span_3_of_2">
					<h3>Half Kg Black Forest</h3>
					<p>cc : 101<br> <font color="green"><?php echo "Rs. $m101"?></p>
					<div class="det_nav" align="right">
					 <iframe src="https://docs.google.com/forms/d/1D-Y94ps4Ta-iAiLu6MrkOaiP4J5pB4kZ3HOQ9D7N_TQ/viewform?embedded=true" width="500" height="700" frameborder="0" marginheight="0" marginwidth="0" align="right">Loading...</iframe>
